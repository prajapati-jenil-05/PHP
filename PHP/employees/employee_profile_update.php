...
<body>
    <div class="card shadow mb-4 mx-3 mt-3">
        ...
        <div class="card-body">
            <form method="post" id="employeeForm" action="update_profile.php" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="col-12 row extra-row">
                        ...
                        <div class="col-l-6 col-xl-6 btn-group" style="text-align: left;">
                            ...
                            <button type="button" class="btn btn-outline-danger" onclick="$('#content').load('employee_profile.php')">Cancel</button>
                        </div>
                    </div>
                </div>
            </form>
